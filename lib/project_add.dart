...
class ProjectAdd extends StatefulWidget {
  ...
  @override
  ProjectAddState createState() => ProjectAddState();
}

// cái này mục tiêu là hiện hay ẩn --> tạo thành 1 file mới thôi (helper)

class ProjectAddState extends State<ProjectAdd> with RestorationMixin {
  ...
  @override
  String get restorationId => 'project_field';
  ...
  Future<void> checkCreateProject() async {
    setState(() {
      isLoading = true;
    });
    ...
    final response = await http.post(
        Uri.parse('http://www.vietinrace.com/srvTD/addProjectPost/'),
        headers: {
          //'Content-Type': 'application/json; charset=UTF-8',
          "Content-Type": "application/x-www-form-urlencoded",
        },
        encoding: Encoding.getByName('utf-8'),
        body: {'name': project.name, 'email': prefs.getString("email")!});
